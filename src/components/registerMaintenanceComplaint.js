...
const  RegisterMaintenanceComplaint= () => {
  ...
  return (
    <>
      ...
      <div className="bg-white  text-gray-800 h-full py-10 overflow-y-auto no-scrollbar">
        <div className="bg-white mx-auto flex max-w-md flex-col rounded-lg lg:max-w-screen-xl lg:flex-row">
